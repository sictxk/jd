...
<head>
	...
	<script type="text/javascript">    
	    function DoDel(Pkid){
	    	var msg='确定要删除年级吗?';
	    	if(confirm(msg)){
	    		window.location.href="/Backend/Grade/remove/pkid/"+Pkid ;
	    	}
	    }
	    function DoEdit(Pkid){
    		window.location.href="/Backend/Grade/edit/pkid/"+Pkid ;
	    }
	</script>
</head>
...
<body>
	...
	<!--<form action="/Backend/Grade/index" method="post" class="formskin">
	...
	<div class="container">
		<table border="1" cellpadding="5" cellspacing="0" width="100%" class="tableskin">
			...
			<?php if(is_array($Grade_list)): $i = 0; $__LIST__ = $Grade_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($i % 2 );++$i;?><tr>
				<td>
					<a href="javascript:DoEdit('<?php echo ($vo["pkid"]); ?>');"><?php echo ($vo["title"]); ?></a>
				</td>

				<?php if($vo["status"] == 'Y'): ?><td align="center"><a href="/Backend/Grade/hide/pkid/<?php echo ($vo["pkid"]); ?>"><img src="/Public/Backend/images/public/yes.gif" /></a></td>
				<?php else: ?>
				<td align="center"><a href="/Backend/Grade/show/pkid/<?php echo ($vo["pkid"]); ?>"><img src="/Public/Backend/images/public/no.gif" /></a></td><?php endif; ?>
