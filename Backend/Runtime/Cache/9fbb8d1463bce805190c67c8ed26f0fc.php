				...
				<div class="tabitem tabitemselected">
					<table border="0" cellpadding="5" cellspacing="0" class="tableform" width="100%">
						...
						<tr>
							...
							<td>
                            <?php if(is_array($grade_list)): $key = 0; $__LIST__ = $grade_list;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$vo): $mod = ($key % 2 );++$key;?><lable><input type="checkbox" name="grade_id[]" value="<?php echo ($vo["pkid"]); ?>" /><?php echo ($vo["title"]); ?></lable><?php endforeach; endif; else: echo "" ;endif; ?>
                            </td>
						</tr>
					</table>
		    	</div>
